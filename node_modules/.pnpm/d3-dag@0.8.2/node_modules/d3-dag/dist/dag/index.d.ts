 ...
 */
export declare type IterStyle = "depth" | "breadth" | "before" | "after";
/**
 ...
 *
 */
export interface Dag<NodeDatum = unknown, LinkDatum = unknown> extends Iterable<DagNode<NodeDatum, LinkDatum>> {
     ...
     */
    idescendants(style?: IterStyle): FluentIterable<DagNode<NodeDatum, LinkDatum>>;
    /**
     ...
     */
    sum(callback: (node: DagNode<NodeDatum, LinkDatum>, index: number) => number): this;
    /**
 ...
 */
export interface DagNode<NodeDatum = unknown, LinkDatum = unknown> extends Dag<NodeDatum, LinkDatum> {
